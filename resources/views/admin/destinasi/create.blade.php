        ...
        <div class="form-container">
            <form action="{{ route('admin.destinasi.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" placeholder="Contoh: Pantai Bali" required>
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" placeholder="Deskripsikan destinasi wisata ini..." required>{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi') }}" placeholder="Contoh: Bali, Indonesia" required>
                        @error('lokasi')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" id="harga" value="{{ old('harga') }}" placeholder="100000" min="1000" step="1000" required>
                        @error('harga')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" placeholder="50" min="1" required>
                    @error('kapasitas')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
